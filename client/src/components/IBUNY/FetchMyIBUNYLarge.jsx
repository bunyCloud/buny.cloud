...
export default function FetchMyIBUNYLarge({contractAddress, abi, refresh}){
...
return(
  ...
  templateColumns={{
    ...
    sm: 'repeat(1, 1fr)', // 2 columns for slightly larger screens
    md: 'repeat(1, 1fr)', // 3 columns for medium screens
    lg: 'repeat(2, 1fr)', // 4 columns for large screens
    xl: 'repeat(2, 1fr)' // 4 columns for extra-large screens
  }}
  gap={2}>
  {nfts.map((nft, i) => (
    <GridItem key={i}>
